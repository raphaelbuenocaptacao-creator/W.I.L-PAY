...
const env = {
  ...
  WILPAY_SERVER_STORAGE_RESTORE_EVIDENCE_RESOURCE_FINGERPRINT: binding.readiness.approval.resource_fingerprint,
  WILPAY_SERVER_STORAGE_RESTORE_EVIDENCE_VERIFIED_AT: '2026-09-12T09:00:00.000Z',
  WILPAY_SERVER_STORAGE_RESTORE_EVIDENCE_REF: 'restore-drill/audit/server-runtime-fixture',
